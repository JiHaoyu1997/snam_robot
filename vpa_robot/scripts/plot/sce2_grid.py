...
# 读取 Excel 文件
df = pd.read_excel(file_path, sheet_name="sce2grid")
...
plt.axhline(y=avg_agent3, color="green", linestyle="--", linewidth=1.5, label=f"Avg Agent 3 Travel Time: {avg_agent3:.2f}s")
...
plt.text(min_agent1_idx-0.3, min_agent1-0.4, f"Agent 1 Min {min_agent1:.2f}s", verticalalignment='top', fontsize=10, color="blue")

plt.scatter(min_agent2_idx, min_agent2, color="orange", marker='s', s=80, edgecolors="black", zorder=3)
plt.text(min_agent2_idx, min_agent2-0.2, f"Agent 2 Min {min_agent2:.2f}s", verticalalignment='top', fontsize=10, color="orange")

plt.scatter(min_agent3_idx, min_agent3, color="green", marker='*', s=80, edgecolors="black", zorder=3)
plt.text(min_agent3_idx, min_agent3-0.2, f"Agent 3 Min {min_agent3:.2f}s", verticalalignment='top', fontsize=10, color="green")

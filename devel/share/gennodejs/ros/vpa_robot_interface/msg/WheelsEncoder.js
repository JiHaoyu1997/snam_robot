...
class WheelsEncoder {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.header = null;
      this.omega_left = null;
      this.omega_right = null;
      ...
      if (initObj.hasOwnProperty('omega_left')) {
        this.omega_left = initObj.omega_left
      }
      else {
        this.omega_left = 0.0;
      }
      if (initObj.hasOwnProperty('omega_right')) {
        this.omega_right = initObj.omega_right
      }
      else {
        this.omega_right = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [omega_left]
    bufferOffset = _serializer.float32(obj.omega_left, buffer, bufferOffset);
    // Serialize message field [omega_right]
    bufferOffset = _serializer.float32(obj.omega_right, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new WheelsEncoder(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [omega_left]
    data.omega_left = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [omega_right]
    data.omega_right = _deserializer.float32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new WheelsEncoder(null);
    ...
    if (msg.omega_left !== undefined) {
      resolved.omega_left = msg.omega_left;
    }
    else {
      resolved.omega_left = 0.0
    }

    if (msg.omega_right !== undefined) {
      resolved.omega_right = msg.omega_right;
    }
    else {
      resolved.omega_right = 0.0
    }
